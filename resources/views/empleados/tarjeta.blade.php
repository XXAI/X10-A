...
<p class="text-justify fuente_datos">
    <strong>C E R T I F I C A C I Ó N &nbsp; D E &nbsp; D O C U M E N T O:</strong> INSTITUTO DE SALUD, TUXTLA GUTIÉRREZ CHIAPAS, AL DÍA <strong class="mayuscula">{{ $fecha_actual }}</strong>, LA SUSCRITA @if ($datos_empleado->FPHONE=='CSSSA017266') DRA. ESTHER GOMEZ JIMENEZ JEFA DEL DISTRITO DE SALUD V.
