...
<p class="text-justify fuente_datos">
    <strong>C E R T I F I C A C I Ó N &nbsp; D E &nbsp; D O C U M E N T O:</strong> INSTITUTO DE SALUD, @if ($datos_empleado->FPHONE=='CSSSA017266') PICHUCALCO @else TUXTLA GUTIÉRREZ @endif  CHIAPAS,AL DÍA <strong class="mayuscula">{{ $fecha_actual }}</strong>, SUSCRITO POR @if ($datos_empleado->FPHONE=='CSSSA017266') DRA. ESTHER GOMEZ JIMENEZ JEFA DEL DISTRITO DE SALUD V.
 @else  I.S.C. ELESBAN HIRAM RAMIREZ SANCHEZ, SUBDIRECTOR DE RECURSOS HUMANOS @endif
    <br><a class="text-center fuente_datos">------------------------------------------------------------------------------------------------<strong>H A C E   C O N S T A R</strong>-----------------------------------------------------------------------------------------------</a><br>
    <a class="text-justify fuente_datos">QUE LA PRESENTE COPIA FOTOSTÁTICA QUE CONSTAN DE UNA (01) FOJA UTIL, ES COPIA FIEL Y EXACTA DEL DOCUMENTO QUE SE TIENE A LA VISTA, QUE OBRA Y FORMA PARTE INTEGRAL DEL SISTEMA DE REGISTRO  ELECTRONICO DE ASISTENCIA DEL C. <?php echo $datos_empleado->Name ?>  CON ID: <?php echo $datos_empleado->Badgenumber ?> @if ($datos_empleado->FPHONE=='CSSSA017266') DE LA OFICINA JURISDICCIONAL DEPENDIENTE DEL DSITRITO DE SALUD V  @else DE LA SUBDIRECCIÓN DE RECURSOS HUMANOS, DEPENDIENTE DE LA DIRECCIÓN DE ADMINISTRACIÓN Y FINANZAS DE ESTE INSTITUTO DE SALUD,@endif LA CUAL SE COMPULSA Y CERTIFICA PARA TODOS LOS EFECTOS LEGALES A QUE HAYA LUGAR; MISMA QUE FIRMO Y SELLO CON FUNDAMENTO EN EL ARTÍCULO 40 FRACCION VII DEL REGLAMENTO INTERIOR DEL INSTITUTO DE SALUD.</a><br>
