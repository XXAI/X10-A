...
class Usuarios extends Model
{
    ...
    protected $fillable = [ 'Badgenumber','Name','Gender','TITLE','PAGER','BIRTHDAY','HIREDDAY','street','CITY','STATE','ZIP','FPHONE','ur_id','MINZU'];//,'ATT','INLATE','OUTEARLY','OVERTIME','SEP','HOLIDAY','MINZU','status'];
