...
class AsistenciaController extends Controller
{
    ...
    // public function consulta_checadas_1(Request $request)
    // {
    //     $arreglo_fecha = array();
    ...
    //     $rm=0;
    //     $rme=0;
    //     //agregue fecha actual en ves de 30 dias
    ...
    //         }
    //         //comente esta linea por que cuando llega al cliente o javascript viene null
    //         // else{
    //         //     $asistencia[$i] = null;
    //         // }
    //     }
    ...
    //     return response()->json(["data" => $asistencia, "validacion"=> $validacion]);
    // }
